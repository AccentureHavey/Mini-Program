...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      url: 'https://api.it120.cc/havey/shop/goods/detail',
      data: {
        id: e.id
      },
      success: function (res) {
  ...
  labelItemTap: function (e) {
    ...
    */
    ...
    if (canSubmit) {
      wx.request({
        url: 'https://api.it120.cc/havey/shop/goods/price',
        data: {
  ...
  */
  ...
  reputation: function (goodsId) {
    var that = this;
    wx.request({
      url: 'https://api.it120.cc/havey/shop/goods/reputation',
      data: {
        goodsId: goodsId
      },
      success: function (res) {
  ...
  getVideoSrc: function (videoId) {
    var that = this;
    wx.request({
      url: 'https://api.it120.cc/havey/media/video/detail',
      data: {
        videoId: videoId
      },
      success: function (res) {
